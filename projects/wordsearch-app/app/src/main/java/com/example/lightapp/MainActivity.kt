...
/**
 * Entry point for the standalone wordsearch(12) app.
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val store = remember { WordsearchSessionStore(applicationContext) }
            ...
            val resume = allSummaries["wordsearch"]?.let { snapshot ->
                ResumeState(
