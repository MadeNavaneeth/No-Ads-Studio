...
import com.example.lightapp.studio.persistence.ConnectSessionStore
import kotlinx.coroutines.launch

/**
 * Entry point for the standalone connect(7) app.
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val store = remember { ConnectSessionStore(applicationContext) }
            ...
            val resume = allSummaries["connect"]?.let { snapshot ->
                ResumeState(
