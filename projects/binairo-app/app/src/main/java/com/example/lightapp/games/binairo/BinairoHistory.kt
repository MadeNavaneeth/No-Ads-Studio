...
/**
 * Undo history for `binairo(10)` — one-cell deltas, in memory only (decision D17;
 ...
 * writing [BinairoMove.previousValue] back. Akari's history, one letter over.
 *
 ...
 * leaves the Playing UI behind, so undo cannot reach across it.
 */
class BinairoHistory(private val bound: Int = DEFAULT_BOUND) {
    ...
    companion object {
        /** Bounded at 50 — decision D17, shared with sudoku, blockpuzzle and akari. */
